...
const BadgeApproved = () => <span className="inline-block px-2 py-0.5 rounded-md text-xs font-semibold bg-green-100 text-green-700">Approved</span>;
const BadgePending = () => <span className="inline-block px-2 py-0.5 rounded-md text-xs font-semibold bg-yellow-100 text-yellow-700">Pending Proof</span>;
...
const TR = ({ cols, children }) => (
  <div className="grid items-center px-3 py-2.5 border border-gray-100 rounded-lg bg-gray-50 hover:bg-gray-100 text-sm card-animate" style={{ gridTemplateColumns: cols }}>
    {children}
  </div>
);
...
// ─── Summary Cards ───
const SummaryCards = () => (
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 list-stagger">
    {[
      ...
      <div key={c.label} className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col gap-1 surface-card">
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-4 flex flex-col gap-1 surface-card">
...
const PackageProrationSection = () => (
  <div className="space-y-6">
    <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
...
const PayslipSection = () => (
  <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
    <div className="flex items-center justify-between mb-4">
      ...
      <button className="h-[40px] bg-[#0575E6] border border-[#E4E9EE] text-white rounded-lg px-6 py-2 text-sm font-medium leading-none shadow-none outline-none focus:outline-none focus:ring-0">
      ...
      {[{month:"Dec 2025",gross:"1,05,000",net:"78,420",date:"31 Dec 2025"},{month:"Nov 2025",gross:"1,02,500",net:"80,010",date:"30 Nov 2025"},{month:"Oct 2025",gross:"1,01,000",net:"76,880",date:"31 Oct 2025"}].map(r=>(
        <TR key={r.month} cols="2fr 1fr 1fr 1fr 80px">
          ...
          <span className="text-right">
            <button className="h-[26px] border border-[#D1D5DB] bg-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">
              Open
            </button>
          </span>
        </TR>
    ...
    <div className="space-y-2">
      {[{section:"80C",sub:"PPF/ELSS/LIC",declared:"1,50,000",proof:"Upload PDF",status:"pending",btn:"Upload"},{section:"80D",sub:"Medical insurance",declared:"25,000",proof:"Uploaded",status:"approved",btn:"View"},{section:"HRA",sub:"Rent receipts",declared:"1,20,000",proof:"Upload receipts",status:"pending",btn:"Upload"}].map(r=>(
        <TR key={r.section} cols="2fr 1fr 1fr 1fr 80px">
          ...
          <span className="text-right">
            {r.btn==="Upload"
              ? <button className="h-[26px] border border-[#E4E9EE] bg-[#0575E6] text-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium shadow-none outline-none focus:outline-none focus:ring-0">Upload</button>
              : <button className="h-[26px] border border-[#D1D5DB] bg-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">View</button>}
          </span>
        </TR>
      ))}
    </div>
...
const IncomeTaxSection = () => (
  <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
    ...
    <p className="text-xs text-[#0575E6] mt-3">This projection uses your current salary + declarations + verified proofs. Changes in variable pay or LOP can change final tax.</p>
    <div className="flex justify-end gap-3 mt-4">
      <button className="h-[40px] border border-[#D1D5DB] bg-white rounded-lg px-5 py-2 text-sm font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">Recalculate</button>
      <button className="h-[40px] bg-[#0575E6] border border-[#E4E9EE] text-white rounded-lg px-5 py-2 text-sm font-medium leading-none shadow-none outline-none focus:outline-none focus:ring-0">Save</button>
    </div>
  </div>
);
...
const Form16Section = () => (
  <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
    ...
    <div className="space-y-2">
      <TR cols="2fr 1fr 1fr 1fr 80px"><span className="font-medium">FY 2024-25</span><span>Available</span><span>Available</span><span><BadgeReady /></span><span className="text-right"><button className="h-[26px] border border-[#E4E9EE] bg-[#0575E6] text-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium shadow-none outline-none focus:outline-none focus:ring-0">Upload</button></span></TR>
      <TR cols="2fr 1fr 1fr 1fr 80px"><span className="font-medium">FY 2025-26</span><span>—</span><span>—</span><span><BadgePending /></span><span className="text-right"><button className="h-[26px] border border-[#D1D5DB] bg-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">Info</button></span></TR>
    </div>
  </div>
);
...
const LoanSection = () => (
  <div className="space-y-6">
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
      ...
      <div className="flex justify-end gap-3 mt-4">
        <button className="h-[40px] border border-[#D1D5DB] bg-white rounded-lg px-5 py-2 text-sm font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">
          Save Draft
        </button>
        <button className="h-[40px] bg-[#0575E6] border border-[#E4E9EE] text-white rounded-lg px-5 py-2 text-sm font-medium leading-none shadow-none outline-none focus:outline-none focus:ring-0">
          Submit
        </button>
      </div>
    </div>
...
const OvertimeSection = () => (
  <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
    ...
    <div className="space-y-2">
      <TR cols="1fr 1fr 1fr 1fr 80px"><span>12 Jan 2026</span><span>1h 30m</span><span><BadgeApproved /></span><span>Jan 2026</span><span className="text-right"><button className="h-[26px] border border-[#D1D5DB] bg-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">Details</button></span></TR>
      <TR cols="1fr 1fr 1fr 1fr 80px"><span>18 Jan 2026</span><span>1h 00m</span><span><BadgePending /></span><span>Jan 2026</span><span className="text-right"><button className="h-[26px] border border-[#E4E9EE] bg-[#0575E6] text-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium shadow-none outline-none focus:outline-none focus:ring-0">Request</button></span></TR>
    </div>
  </div>
);
...
const AnnualPayslipSection = () => (
  <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
    ...
    <div className="space-y-2">
      <TR cols="1fr 1fr 1fr 1fr 80px"><span>Dec 2025</span><span className="font-semibold">₹ 1,05,000</span><span className="font-semibold">₹ 26,580</span><span className="font-semibold">₹ 78,420</span><span className="text-right"><button className="h-[26px] border border-[#D1D5DB] bg-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">View</button></span></TR>
      <TR cols="1fr 1fr 1fr 1fr 80px"><span>Nov 2025</span><span className="font-semibold">₹ 1,02,000</span><span className="font-semibold">₹ 22,490</span><span className="font-semibold">₹ 80,010</span><span className="text-right"><button className="h-[26px] border border-[#D1D5DB] bg-white rounded-md px-2.5 py-0 text-[11px] leading-none font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">View</button></span></TR>
    </div>
    <div className="flex justify-end gap-3 mt-4">
      <button className="h-[40px] border border-[#D1D5DB] bg-white rounded-lg px-5 py-2 text-sm font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">Download Annual PDF</button>
      <button className="h-[40px] bg-[#0575E6] border border-[#E4E9EE] text-white rounded-lg px-5 py-2 text-sm font-medium leading-none shadow-none outline-none focus:outline-none focus:ring-0">Email Statement</button>
    </div>
  </div>
);
const SalaryAdvanceSection = () => (
  <div className="space-y-6">
    <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
      ...
      <div className="flex flex-col gap-1 mt-4"><label className="text-xs font-medium">Reason</label><textarea className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-white outline-none focus:border-indigo-500 h-20 resize-none" placeholder="Enter reason" /></div>
      <div className="flex justify-end gap-3 mt-4">
        <button className="h-[40px] border border-[#D1D5DB] bg-white rounded-lg px-5 py-2 text-sm font-medium text-[#344054] shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-gray-50">Save Draft</button>
        <button className="h-[40px] bg-[#0575E6] border border-[#E4E9EE] text-white rounded-lg px-5 py-2 text-sm font-medium leading-none shadow-none outline-none focus:outline-none focus:ring-0">Submit Request</button>
      </div>
    </div>
    <div className="bg-white border border-gray-200 rounded-xl p-5 surface-card card-animate">
      <h4 className="font-semibold text-sm mb-3">Monthly Summary</h4>
...
const PayrollDashboard = () => {
  ...
  const handlenavigate =()=>{
    navigate('/dashboard/run-payroll')
  }

  return (
    <div className="min-h-screen bg-gray-50 card-animate">
      <div className=" mx-auto px-6 py-6">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button className="flex items-center gap-2 bg-gray-200 border border-gray-300 rounded-lg px-6 py-2 text-sm font-medium text-[#212529] shadow-none outline-none focus:outline-none focus:ring-0">
              Policy
            </button>
            <button className="flex items-center gap-2 bg-[#0575E6] border border-[#E4E9EE] rounded-lg px-6 py-2 text-sm font-medium text-white shadow-none outline-none focus:outline-none focus:ring-0">
              Raise Query
            </button>
          </div>
        </div>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="relative">
                  <button
                    ...
                    className="border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-medium bg-white flex items-center gap-2 min-w-56 justify-between hover:bg-gray-50 shadow-none"
                  >
                    {activeSection} <ChevronDownIcon />
                  </button>
                  {dropdownOpen && (
                    <div className="absolute left-0 top-full mt-1 bg-white border border-gray-200 rounded-xl shadow-none z-20 min-w-64 overflow-hidden card-animate">
                      {DROPDOWN_ITEMS.map(item=>(
                        <button
                          key={item}
                          onClick={()=>{setActiveSection(item);setDropdownOpen(false);}}
                          className={`block w-full text-left px-4 py-2.5 text-sm hover:bg-blue-50 active:bg-blue-100 transition-colors shadow-none ${activeSection===item?"font-semibold bg-blue-50":""}`}
                        >{item}</button>
                      ))}
                    </div>
                  )}
                ...
                <div className="relative" ref={monthDropdownRef}>
                  <button
                    ...
                    className="h-[40px] min-w-[170px] border border-[#DEE2E6] rounded-lg px-4 text-[14px] font-medium text-[#344054] bg-white cursor-pointer outline-none focus:outline-none focus:ring-0 shadow-none flex items-center justify-between gap-2"
                  >
                    {selectedMonth} <ChevronDownIcon />
                  </button>
                  {isMonthOpen && (
                    <div className="absolute right-0 top-full mt-2 w-[170px] rounded-lg border border-gray-200 bg-white shadow-none z-20 overflow-hidden card-animate">
                      {["This Month", "Last Month", "Last 3 Months"].map((item) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2 text-sm border-none shadow-none outline-none focus:outline-none focus:ring-0 hover:bg-blue-50 active:bg-blue-100 transition-colors ${
                            selectedMonth === item ? "bg-blue-50 font-medium" : ""
                          }`}
                        >
                          {item}
                        </button>
