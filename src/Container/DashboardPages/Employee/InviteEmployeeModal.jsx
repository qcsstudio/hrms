              ...
              <div className="px-6 pt-4">
                <div className="flex bg-[#F9FAFB] rounded-lg p-1">
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-medium rounded-md ${activeTab === "email"
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-medium rounded-md ${activeTab === "phone"
                      ? "bg-white shadow text-[#344054]"
                      : "text-[#667085]"
                      }`}
                  >
