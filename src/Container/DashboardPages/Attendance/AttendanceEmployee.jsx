    ...
    return (
        <div className='p-[10px] bg-[#F8F9FA] '>
            ...
            <div className='flex gap-[10px] mt-5' >
                <select className='border border-[#DEE2E6] font-semibold text-[#344054] bg-[#FFFFFF] w-[230px] h-[40px] p-[8px]  rounded'>
            ...
            <div className='flex mt-8 gap-4'>
                <div className=' w-[50%] bg-[#FFFFFF] p-5'>
                    <h1 className='font-medium '>My Actions</h1>
                    <p className='text-[12px] text-[#000000]/35 mb-4'>Self-service actions only.</p>

                    <div className=' flex flex-wrap w-[100%] gap-[12px] '>

                        {cards.map((item, index) => (
                            <div key={index} className='border-2 border-[#DEE2E6] rounden-md w-[48%] h-[84px] rounded p-3 space-y-2 '>
                                <div className='text-[#000000]/35 text-[12px] '>{item.name}</div>
                                <div className='text-[15px] '>{item.time}</div>
                ...
                <div className=' w-[50%] bg-[#FFFFFF] p-5  '>
                    ...
                    <div className='flex justify-between'>
                        <div>
                            ...
                            <p className='text-[12px] text-[#000000]/35 mb-4'>Quick monthly overview (P/L/A/NM)</p>
                    ...
                    <div>
                        <div className='flex  w-[100%] flex-wrap gap-[12px]'>
                            {Attandance.map((item, index) => (
                                <div key={index} className='border-2 border-[#DEE2E6] rounden-md w-[48%] h-[84px] rounded p-3 space-y-2 '>
                                    <div className='text-[#000000]/35  '>{item.name}</div>
                    ...
                    <div className='flex w-full  justify-between mt-[25px] '>
                        {day.map((item, index) => (
                            <div key={index} className='border-2 border-[#DEE2E6] rounded-md w-[70px] h-[75px] text-center py-1 '>
            ...
            <div className=' mt-[20px]'>
                ...
                <div className='flex justify-between w-[100%]  '>
                    <div className='space-y-1' >
                        <h1 className='font-bold text-[20px] w-[100%]' >Exceptions & My Requests</h1>
                        <p className='text-[#000000]/35 text-[12px]'>Fix issues quickly and track approvals</p>
                    </div>
                    <div>
                ...
                <div className='mt-[10px] flex justify-between w-[100%]  '>
                    <div className='w-[50%] bg-white p-5 rounded-xl'>
                    ...
                    <div className='w-[49%] bg-white p-5 rounded-xl'>
            ...
            <div className='mt-[30px] '>
                <div className='flex justify-between'>
                    <div className='space-y-1'>
                        <h1 className='font-bold text-[20px]'>My Attendance Log</h1>
                        <p className='text-[#000000]/35 text-xs' >Last 7 days (Quick Audit)</p>
                ...
                <div className='mt-[4px] '>
                    <ul className='flex justify-between text-[#8F97A3]  text-[16px] p-4'>
                        <li>Date</li>
                        <li>In</li>
                        <li>Out</li>
                        <li>Hours</li>
                    ...
                    <hr className='border-b-2 border-[#E3E5E8]'/>
                    <div className='mt-[20px]' >
